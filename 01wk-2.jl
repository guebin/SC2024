...
# ╔═╡ a88c4e3e-4a51-4682-b4a5-b70397bb6f4f
html"""
<div style="display: flex; justify-content: center;">
<div  notthestyle="position: relative; right: 0; top: 0; z-index: 300;">
<iframe src=
"
https://youtube.com/embed/playlist?list=PLQqh36zP38-yyajIYcPTq0bBYidxy365A&si=2JPSFjoR2d8jLIMY
"
...
# ╔═╡ 15c1f09a-d2ca-4cce-9a53-7bb56e8dd263
md"""
-- 예시1: 벡터 + 벡터
"""
...
# ╔═╡ 958e1012-e2f4-4f48-8b12-cc585875c481
md"""
-- 예시2: 벡터 .+ 스칼라
"""

# ╔═╡ 4cf04fd1-a07b-491a-8aed-9e9061c52f76
md"""
*방법1*
"""
...
# ╔═╡ 7987a3bc-cdd7-46db-9991-ed1dc5fe5b63
md"""
*방법2*
"""

# ╔═╡ d7d4a2a3-197b-4f81-8172-e253b556bbf0
@. [1,2,3] + 1
# 이런코드도 가능함.

# ╔═╡ 9219b778-744c-464d-b712-d36112e24818
md"""
-- 예시3: f: 스칼라 $\to$ 스칼라
"""

# ╔═╡ 1eb01c8b-8f01-4ae0-b359-34f419864f5a
md"""
*방법1*
"""

# ╔═╡ b2b90651-4b05-49bc-8c49-617e926ce6a5
[1,2,3] .|> (x -> x^2)

# ╔═╡ 150a9ba9-03f9-4956-9eb3-fc6f4533fda8
md"""
*방법2*
"""

# ╔═╡ 02d650a0-4289-47eb-a971-fa25baed4622
@. [1,2,3] |> (x -> x^2) |> (x->x+10) 
# 위의코드는
# [1,2,3] .|> (x -> x^2) .|> (x->x+10) 
# 와 같다 

# ╔═╡ 16b97721-887b-40dc-bf90-b7fec3e8a2c6
md"""
*까다로운 응용*
"""

# ╔═╡ ea1db2fb-15d1-4551-98e6-0fab557b5da0
(@. [1,2,3] |> (x -> x^2) |> (x->x+10)) |> mean
# 위의 코드는 아래와 같다. 
# [1,2,3] .|> (x -> x^2) .|> (x->x+10) |> mean

# ╔═╡ 7bc1fdb8-1ba8-46a2-a2bf-3134ad99ba39
md"""
-- 예시4: f: 벡터 $\to$ 스칼라
"""

# ╔═╡ 8b0e6bc7-c9c9-45ab-9c47-d4123244a69c
[1,2,3] |> mean

# ╔═╡ d06a535d-5515-4152-9b58-4d036a17f7d0
md"""
-- 예시5: f: 벡터 $\to$ 벡터
"""

# ╔═╡ 9b95fb28-9eac-4b53-ab6d-57fd0e300b1d
[1,2,3] * 2 # 이건 계산되네? 
# 참고로 [1,2,3] + 1은 계산안되었음. 

# ╔═╡ 546d714e-2711-4263-a6d9-2f6406753abe
md"""
- `(x-> 2x)` 는 `벡터입력 -> 벡터출력` 으로 동작하기도 하고 `스칼라입력 -> 스칼라출력` 으로 동작하기도함. 
- `(x-> x+1)` 는 `스칼라입력 -> 스칼라출력` 만 가능함.
"""

# ╔═╡ 37048083-01e4-42b1-a2d9-bc73c194448c
[1,2,3] |> (x-> 2x)
# 이때 (x->2x) 는 벡터입력 -> 벡터출력으로 해석

# ╔═╡ bceff24e-f09e-4939-9ea8-0f05dd5c9fde
md"""
-- 예시6: f: 벡터 $\to$ 벡터
"""

# ╔═╡ 3a939e80-9fc3-4605-b0c8-bb14a4c40eea
[1,2] |> ( lst -> [lst[1]+100,lst[2]+200] )

# ╔═╡ 641dd83a-307c-4d0c-b6d8-9c9447289acd
md"""
-- 예시7: f: 스칼라 $\to$ 벡터
"""

# ╔═╡ 4a541c22-7902-4898-8a20-5d09e7ea3d2d
let 
