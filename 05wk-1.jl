...
# ╔═╡ 13f8b39e-500e-43d3-a96c-5bb27d8f0047
html"""
<div style="display: flex; justify-content: center;">
<div  notthestyle="position: relative; right: 0; top: 0; z-index: 300;">
<iframe src=
"
https://youtube.com/embed/playlist?list=PLQqh36zP38-wDF4NB9y7nK3uO6ZhtCtYV&si=yvt21gAGTKpjfAmI
"
...
# ╔═╡ 4e642cc1-3c64-400f-884e-ee5187fb792d
let 
	function a(n)
		if n ≤ 2 
			return 1 
		else 
			return a(n-1)+a(n-2) # 엥 a(n)을 정의하지 않았는데???
		end
	end
	[a(n) for n in 1:10]
end 
...
# ╔═╡ 44f9d380-44b0-45ad-82f6-29d3dad22e8a
let 
	f(x)=sin(x)
	g = ∂(f)
	plot(f)
...
let 
	...
	a,b = 2,3 
	histogram(a*X .+ b)
	histogram!(rand(Normal(b,0.1a),N))
end 
...
let 
	...
	g(x) = x*(1-x)
	Y = @. g(X)
	println("slope at x=$p : $(slope(g,p))")
	plot(g,xlim=(0,1))
	scatter!(X,Y)
end 
...
# ╔═╡ b2351c2e-3113-4991-8202-44b4efacf3af
md"""
!!! info "델타메소드 사용시 주의점"
	``g(x)``가 $S_n$의 평균에서 기울기가 0인 직선이라면 델타메소드를 사용할 수 없다. (분산이 0으로 가므로)
"""

# ╔═╡ 2ec73b7c-816c-440e-a240-143770b24f9f
md"""
## 6. HW
"""

# ╔═╡ 2dbc8eea-a815-4ee9-9eca-a881c3c1401a
md"""
아래의 문제 3,4,5를 풀것. (제출의무X)

<https://guebin.github.io/SC2022/0428.html>
"""
