...
begin
	Plots.plotly()
	default(markersize = 2, markerstrokewidth = 0)
end
...
let 
	...
	Ṽ = [V1 V2 V3*0]
	p1 = iris_plot(X,y)
	p2 = iris_plot(X*V*V',y)
	p3 = iris_plot(X*Ṽ*V',y)
	p4 = iris_plot(X*[V1 V2]*[V1 V2]',y)
	@show Ṽ*V' ≈ [V1 V2]*[V1 V2]'
	plot(p1,p4,legend=false)
end	
...
md"""
!!! warning "직관2: 사영행렬"
	데이터는 어떠한 공간에 적절히 rojection 된 것 처럼 보이는데? (데이터가 적절히 "요약"된 것 처럼 보이는데?)
"""
...
!!! info "PCR" 
	...
	이 추정값을 이용하면 아래와 같이 ${\boldsymbol \beta}$ 를 추정할 수 있다. 
