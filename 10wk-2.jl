...
begin
	j = ones(200)
	Choco = [Dict("choco"=>1, "vanilla"=>0)[i] for i in ic2.type]
	Vanilla = [Dict("choco"=>0, "vanilla"=>1)[i] for i in ic2.type]
...
manifest_format = "2.0"
project_hash = "740d8ea8bda1727503b683d5556159247aab90f1"
